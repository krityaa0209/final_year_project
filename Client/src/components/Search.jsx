    ...
    "
      ...
      >
        ...
        <button type="submit" className="absolute right-1 cursor-pointer">
          <img src={searchIcon} className="w-[20px] h-auto" alt="search" />
        </button>
      </form>
      {searchText.length > 0 ? (
        <ul
...
backdrop-blur-md scrollbar-thin scrollbar-thumb-gray-100 scrollbar-track-gray-800
"
        >
          {searchData ? (
            searchData.map((coin) => {
            ...
            >
             ...
             border-b-gray-800 animate-spin
             "
                role="status"
              />
