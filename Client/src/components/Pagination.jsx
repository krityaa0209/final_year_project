      ...
      <div className="flex items-center">
        ...
        <ul className="flex items-center justify-end text-sm">
          <li className="flex items-center">
            <button className="outline-0 hover:text-black w-8" onClick={prev}>
              <img
          ...
          {page + 1 === TotalNumber || page === TotalNumber ? (
            <li>
              ...
              <button
                ...
                className="ouline-0 hover:text-black  rounded-full w-8 h-8 flex items-center justify-center text-lg    "
              >
                ...
              </button>
            </li>
          ...
          {page - 1 !== 0 ? (
            <li>
              <button
                onClick={prev}
                className="ouline-0 hover:text-black  rounded-full w-8 h-8 flex items-center justify-center bg-gray-800 mx-1.5"
              >
                {" "}
                {page - 1}{" "}
              </button>
          ...
          <li>
            <button
              disabled
              className="ouline-0  rounded-full w-8 h-8 flex items-center justify-center bg-cyan text-black mx-1.5"
            >
              {page}
            </button>
          </li>
          ...
          <li>
            <button className="outline-0 hover:text-white w-8" onClick={next}>
              <img
