  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        setpPrice(response.data.Last_stock_Price);
        console.log(
          "Response from Flask server:",
          response.data.Last_stock_Price
        );
    ...
    if (data) {
      ...
      // Store the formatted value in the state
      ...
      setPriceAsNumber(numericValue);
    }
  }, [data]);

  const percentage = ((pPrice - priceAsNumber)/priceAsNumber)*100;
      ...
      >
        ...
        "
              ...
              <div className="flex w-full mt-6">
                <div className="flex flex-col w-full justify-between">
                  ...
                  <div className="flex justify-between">
                    ...
                    <h2 className="text-lg font-bold">
                      {pPrice ? "$" + pPrice.toFixed(2) : "loading..."}
                    </h2>
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-col w-full mt-4 justify-between">
                ...
                <span>{(InvestAmt * (1 + (percentage/100))).toFixed(2)}</span>
              </div>
